...
find ./app/src/test/java -type f -name "*.java" -exec sed -i.bak 's/com.fsstudio.template/'"$package_name"'/g' {} +
...
mv -f ./app/src/test/java/com/fsstudio/template ./app/src/test/java/com/fsstudio/${package_name_arr[2]} 2>/dev/null; true
mv -f ./app/src/test/java/com/fsstudio ./app/src/test/java/com/${package_name_arr[1]} 2>/dev/null; true
mv -f ./app/src/test/java/com ./app/src/test/java/${package_name_arr[0]} 2>/dev/null; true
